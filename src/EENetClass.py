...
class Exploration:
    def __init__(self, input_dim, lr=0.001, kernel_size=100, network_class=None):
        network_class = network_class or Network_exploration
        self.func = network_class(
            input_dim=input_dim, _kernel_size=kernel_size
        ).to(device)
        self.context_list = []
        self.reward = []
        self.lr = lr
