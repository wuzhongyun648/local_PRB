import numpy as np
from EENetClass_origin import Exploitation, Exploration, Decision_maker
import pdb

class EE_Net:
    def __init__(self, dim, n_arm, pool_step_size, lr_1 = 0.01, lr_2 = 0.01, lr_3 = 0.01, hidden=100, neural_decision_maker = False,kernel_size=100):
        #Network 1
